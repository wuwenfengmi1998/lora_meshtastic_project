...
const RegionInfo regions[] = {
    ...
    */
    RDEF(US, 902.0f, 928.0f, 100, 0, SETTING_MAX_POWER, true, false, false),
     ...
     */
    RDEF(EU_433, 433.0f, 434.0f, 10, 0, SETTING_MAX_POWER, true, false, false),
     ...
     */
    RDEF(EU_868, 869.4f, 869.65f, 10, 0, SETTING_MAX_POWER, false, false, false),
     ...
     */
    RDEF(JP, 920.5f, 923.5f, 100, 0, SETTING_MAX_POWER, true, false, false),
    ...
    /*
        ...
        Also used in Brazil.
     */
    RDEF(ANZ, 915.0f, 928.0f, 100, 0, SETTING_MAX_POWER, true, false, false),
     ...
     */
    RDEF(ANZ_433, 433.05f, 434.79f, 100, 0, SETTING_MAX_POWER, true, false, false),
     ...
     */
    RDEF(RU, 868.7f, 869.2f, 100, 0, SETTING_MAX_POWER, true, false, false),

    /*
        https://www.law.go.kr/LSW/admRulLsInfoP.do?admRulId=53943&efYd=0
        https://resources.lora-alliance.org/technical-specifications/rp002-1-0-4-regional-parameters
     */
    RDEF(KR, 920.0f, 923.0f, 100, 0, SETTING_MAX_POWER, true, false, false),
     ...
     */
    RDEF(TW, 920.0f, 925.0f, 100, 0, SETTING_MAX_POWER, true, false, false),

    /*
        https://lora-alliance.org/wp-content/uploads/2020/11/lorawan_regional_parameters_v1.0.3reva_0.pdf
     */
    RDEF(IN, 865.0f, 867.0f, 100, 0, SETTING_MAX_POWER, true, false, false),

    /*
         https://rrf.rsm.govt.nz/smart-web/smart/page/-smart/domain/licence/LicenceSummary.wdk?id=219752
         https://iotalliance.org.nz/wp-content/uploads/sites/4/2019/05/IoT-Spectrum-in-NZ-Briefing-Paper.pdf
      */
    RDEF(NZ_865, 864.0f, 868.0f, 100, 0, SETTING_MAX_POWER, true, false, false),

    /*
       https://lora-alliance.org/wp-content/uploads/2020/11/lorawan_regional_parameters_v1.0.3reva_0.pdf
    */
    RDEF(TH, 920.0f, 925.0f, 100, 0, SETTING_MAX_POWER, true, false, false),

    /*
        433,05-434,7 Mhz 10 mW
        https://nkrzi.gov.ua/images/upload/256/5810/PDF_UUZ_19_01_2016.pdf
    */
    RDEF(UA_433, 433.0f, 434.7f, 10, 0, SETTING_MAX_POWER, true, false, false),

    /*
        868,0-868,6 Mhz 25 mW
        https://nkrzi.gov.ua/images/upload/256/5810/PDF_UUZ_19_01_2016.pdf
    */
    RDEF(UA_868, 868.0f, 868.6f, 1, 0, SETTING_MAX_POWER, true, false, false),
    ...
    */
    RDEF(MY_433, 433.0f, 435.0f, 100, 0, SETTING_MAX_POWER, true, false, false),
    ...
    /*
        ...
        https://www.mcmc.gov.my/skmmgovmy/media/General/pdf/Short-Range-Devices-Specification.pdf
    */
    RDEF(MY_919, 919.0f, 924.0f, 100, 0, SETTING_MAX_POWER, true, true, false),
    ...
    */
    RDEF(SG_923, 917.0f, 925.0f, 100, 0, SETTING_MAX_POWER, true, false, false),
    ...
    */
    ...
    RDEF(PH_433, 433.0f, 434.7f, 100, 0, SETTING_MAX_POWER, true, false, false), RDEF(PH_868, 868.0f, 869.4f, 100, 0, 14, true, false, false),
    RDEF(PH_915, 915.0f, 918.0f, 100, 0, SETTING_MAX_POWER, true, false, false),
    ...
    */
    RDEF(KZ_433, 433.075f, 434.775f, 100, 0, SETTING_MAX_POWER, true, false, false),
    RDEF(KZ_863, 863.0f, 868.0f, 100, 0, SETTING_MAX_POWER, true, false, false),
    ...
    */
    RDEF(NP_865, 865.0f, 868.0f, 100, 0, SETTING_MAX_POWER, true, false, false),
    ...
    */
    RDEF(BR_902, 902.0f, 907.5f, 100, 0, SETTING_MAX_POWER, true, false, false),

    /*
       2.4 GHZ WLAN Band equivalent. Only for SX128x chips.
    */
    RDEF(LORA_24, 2400.0f, 2483.5f, 100, 0, SETTING_MAX_POWER, true, false, true),

    /*
        This needs to be last. Same as US.
    */
    RDEF(UNSET, 902.0f, 928.0f, 100, 0, SETTING_MAX_POWER, true, false, false)
